...
function Post({
  ...
  return /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsx("div", { style: {
      ...
      right: "1.8rem",
      zIndex: 100
    }, children: /* @__PURE__ */ jsx("button", { onClick: onClose, style: {
      fontFamily: "'Outfit', sans-serif",
      fontSize: "0.65rem",
      fontWeight: 500,
      letterSpacing: "0.2em",
    ...
    /* @__PURE__ */ jsxs("article", { style: {
      ...
      post.content.map((p, i) => /* @__PURE__ */ jsx("p", { style: {
        fontFamily: "'Outfit', sans-serif",
        fontSize: "18.4px",
        fontWeight: 300,
        lineHeight: "34.96px",
      ...
      post.content2.map((p, i) => /* @__PURE__ */ jsx("p", { style: {
        fontFamily: "'Outfit', sans-serif",
        fontSize: "18.4px",
        fontWeight: 300,
        lineHeight: "34.96px",
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("p", { style: {
          ...
          marginBottom: "1rem",
          fontStyle: "italic"
        }, children: post.videoLabel }),
        /* @__PURE__ */ jsx("iframe", { src: post.videoSrc, style: {
          width: "100%",
          aspectRatio: "16/9",
          border: "none"
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("a", { href: post.cta.href, style: {
          fontFamily: "'Outfit', sans-serif",
          fontSize: "18.4px",
          fontWeight: 300,
          color: post.id === 2 ? "rgba(237,234,226,0.5)" : "#c86c2e",
          textDecoration: "none"
        }, children: /* @__PURE__ */ jsx("span", { style: {
          color: post.id === 2 ? "rgba(237,234,226,0.5)" : "#c86c2e"
        }, children: post.cta.label }) })
      ] })
    ] })
  ] });
}
function BlogPage() {
  const posts = [{
    ...
    cta: {
      label: "This is also why I do what I do →",
      href: "/purpose"
    }
  }, {
    id: 2,
    ...
    content: [`Nobody grows up dreaming of a shared flat.`, `You dream of your own space. Your own kitchen. A bathroom where the shampoo bottles are all yours. A sofa that nobody else has claimed. Maybe a plant. Definitely a plant.`, `Instead, a lot of us got something else: six years of other people's dirty dishes, questionable WiFi agreements, houses that never quite felt like home, and the particular intimacy of knowing exactly when your flatmates go to bed, what they eat when they're sad, and which one of them always uses the last of the toilet paper without saying anything.`, `It's not what we planned. But I've been thinking lately about what it gave us.`],
    quote: `We became, quietly and without realising it, good at community.`,
    content2: [`We learned to negotiate. To share. To live in close quarters with people who didn't choose us and didn't always understand us. We learned to read moods in a corridor, to give space in a small apartment, to build something resembling peace in conditions that weren't designed for it.`, `And now I look around at my generation and I see something interesting happening. We're not rushing toward the isolated dream of a house behind a fence. We're renting with friends by choice. We're co-working in cafés because we don't want to be alone. We're building group chats that function like neighbourhoods. We're choosing proximity.`, `Maybe the shared flat didn't just teach us to survive inconvenience. Maybe it rewired how we think about what home means.`, `There's a version of this story where shared living is just a symptom of economic failure — where we talk ourselves into romanticising something that was never really a choice. And that version is true, too. It wasn't always fun. There were nights I would have paid anything for a door that locked from the inside and a kitchen that was just mine.`, `But I've also had conversations at 2am over someone else's pasta that I wouldn't trade. I've learned things about myself by being forced to coexist with people I would never have chosen to know. I've understood, slowly, that living alone with your preferences perfectly met might be comfortable — but it's not the same as learning to belong somewhere.`, `We are a generation that has been told, repeatedly, that independence is the goal. Your own space. Your own rules. Your own everything. And yet most of us, given a free afternoon, call our friends. We show up at each other's houses. We make plans that involve other people.`, `Maybe the shared flat wasn't the compromise on the way to the real thing. Maybe it was quietly teaching us what the real thing actually looks like.`, `A house would be nice. I won't pretend it wouldn't. But a big one — with people you love nearby, walls you've covered with your own things, a kitchen where someone's always cooking something — that sounds less like a compromise and more like exactly what I actually want.`],
    ...
    cta: {
      label: "I'm building something around this idea →",
      href: "/work/commo2",
      color: "#ffffff"
    }
  }];
  const [selected, setSelected] = useState(null);
  if (selected) return /* @__PURE__ */ jsx(Post, { post: selected, onClose: () => setSelected(null) });
  return /* @__PURE__ */ jsxs("div", { style: {
    minHeight: "100vh",
    background: "#070709",
    color: "#edeae2",
    ...
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsx("h1", { style: {
        ...
        letterSpacing: "0.02em",
        marginBottom: "5rem"
      }, children: "Things worth saying." }),
      /* @__PURE__ */ jsx("div", { style: {
        display: "flex",
        flexDirection: "column",
        gap: "1.5rem"
      }, children: posts.map((post) => /* @__PURE__ */ jsxs("div", { onClick: () => setSelected(post), style: {
        cursor: "pointer",
        display: "block",
        padding: "2.5rem",
        ...
        e.currentTarget.style.borderColor = "#c86c2e";
        e.currentTarget.style.background = "rgba(200,108,46,0.08)";
        e.currentTarget.style.boxShadow = "0 0 24px rgba(200,108,46,0.2)";
        e.currentTarget.style.transform = "translateY(-2px)";
      }, onMouseLeave: (e) => {
        e.currentTarget.style.borderColor = "rgba(237,234,226,0.12)";
        e.currentTarget.style.background = "rgba(7,7,9,0.55)";
