    ...
    <div style={{ minHeight: '100vh', background: 'transparent', color: '#ffffff', position: 'relative' }}>
      ...
      <div style={{ maxWidth: 980, margin: '0 auto', padding: '10rem 3.5rem 6rem', position: 'relative', zIndex: 2 }}>
        <div style={{ marginBottom: '5rem' }}>
          ...
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '18.4px', fontWeight: 300, lineHeight: '34.96px', color: 'rgba(255,255,255,0.9)', marginBottom: '0.5rem' }}>This is who I am and where I come from.</p>
        </div>
