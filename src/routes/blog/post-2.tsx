    ...
    <div style={{ minHeight: '100vh', background: 'transparent', color: '#8a2333', position: 'relative' }}>
      ...
      <article style={{ maxWidth: '720px', margin: '0 auto', padding: '10rem 3.5rem 8rem', position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ margin: '3rem 0' }}>
          ...
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.75rem', fontWeight: 300, color: 'rgba(138,35,51,0.55)', marginBottom: '1rem', fontStyle: 'italic' }}>Sebastian Junger — Why veterans miss war (on tribe, belonging and community)</p>
          <iframe
        ...
        <div style={{ marginTop: '5rem', paddingTop: '3rem', borderTop: '1px solid rgba(138,35,51,0.15)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Link to="/work/commo2" style={{ fontFamily: "'Outfit', sans-serif", fontSize: '18.4px', fontWeight: 300, color: '#8a2333', textDecoration: 'none' }}>I'm building something around this idea →</Link>
        </div>
      </article>
    </div>
  )
