    ...
    <div style={{ minHeight: '100vh', background: '#070709', color: '#edeae2', position: 'relative' }}>
      ...
      <article style={{ maxWidth: 860, margin: '0 auto', padding: '10rem 3.5rem 8rem', position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ marginBottom: '4rem' }}>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.62rem', fontWeight: 600, letterSpacing: '0.38em', textTransform: 'uppercase', color: '#edeae2', marginBottom: '2rem' }}>Master's Final Project · 2024—2025</p>
          <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', marginBottom: '2.5rem' }}>
            <img src="/photos/commo2/commo2-main-logo.png" alt="Commo2" style={{ height: '80px', width: 'auto', objectFit: 'contain' }} />
            <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '64px', fontWeight: 400, color: '#edeae2', lineHeight: 1, letterSpacing: '0.02em', margin: 0 }}>Commo2</h1>
          </div>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '18.4px', fontWeight: 300, lineHeight: '34.96px', color: 'rgba(237,234,226,0.9)' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.6rem', marginBottom: '5rem' }}>
          {tags.map((tag, i) => (
            <span key={i} style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.62rem', fontWeight: 500, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(237,234,226,0.6)', border: '1px solid rgba(237,234,226,0.15)', padding: '0.5rem 1rem' }}>
              {tag}
            </span>
          ))}
        </div>

        <div style={{ marginBottom: '5rem', paddingBottom: '5rem', borderBottom: '1px solid rgba(237,234,226,0.08)' }}>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.62rem', fontWeight: 600, letterSpacing: '0.38em', textTransform: 'uppercase', color: '#edeae2', marginBottom: '2rem' }}>What it is</p>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '18.4px', fontWeight: 300, lineHeight: '34.96px', color: 'rgba(237,234,226,0.9)', marginBottom: '1.6rem' }}>
        ...
        <div style={{ marginBottom: '5rem', paddingBottom: '5rem', borderBottom: '1px solid rgba(237,234,226,0.08)' }}>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.62rem', fontWeight: 600, letterSpacing: '0.38em', textTransform: 'uppercase', color: '#edeae2', marginBottom: '2rem' }}>Why it's necessary</p>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '18.4px', fontWeight: 300, lineHeight: '34.96px', color: 'rgba(237,234,226,0.9)', marginBottom: '1.6rem' }}>
        ...
        <blockquote style={{ borderLeft: '3px solid #c86c2e', padding: '1.2rem 0 1.2rem 2rem', margin: '0 0 5rem', fontFamily: "'Outfit', sans-serif", fontSize: '18.4px', fontWeight: 300, color: 'rgba(237,234,226,0.55)', lineHeight: '34.96px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.75rem' }}>
          {[
            ...
            <div key={i} style={{ border: '1px solid rgba(237,234,226,0.1)', padding: '2rem 1.5rem' }}>
              <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '3rem', color: '#edeae2', margin: '0 0 0.3rem', lineHeight: 1 }}>{num}</p>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.65rem', fontWeight: 400, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(237,234,226,0.45)', margin: 0 }}>{label}</p>
            </div>
          ))}
        </div>

        <div style={{ marginTop: '5rem', paddingTop: '3rem', borderTop: '1px solid rgba(237,234,226,0.08)' }}>
          <Link to="/projects" style={{ fontFamily: "'Outfit', sans-serif", fontSize: '0.7rem', fontWeight: 500, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#edeae2', textDecoration: 'none' }}>← Back to projects</Link>
        </div>
